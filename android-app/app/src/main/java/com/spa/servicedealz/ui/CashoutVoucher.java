 ...
 */
public class CashoutVoucher extends AppCompatActivity implements View.OnClickListener {
    private Button mButtonAmazon, mButtonWalmart, mButtonCancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.giftcard_voucher);
    ...
    private void MapIngId() {
        mButtonAmazon = (Button) findViewById(R.id.btn_amazon);
        mButtonCancel = (Button) findViewById(R.id.btn_cancel);
        mButtonWalmart = (Button) findViewById(R.id.btn_get_walmart);
        mTextViewAmount = (TextView) findViewById(R.id.txt_available_balance);
        mButtonAmazon.setOnClickListener(this);
        mButtonCancel.setOnClickListener(this);
        mButtonWalmart.setOnClickListener(this);
    ...
    private void setActionBar() {
        ...
        toolbar.setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" + "Cashout Voucher" + "</font>")));
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_amazon:
                ...
                mEditor.putString("cashout_voucher", "amazon");
                mEditor.commit();
            ...
            case R.id.btn_cancel:
                finish();
                break;
            case R.id.btn_get_walmart:
                mEditor.putString("cashout_voucher", "walmart");
                mEditor.commit();
                Intent intent1 = new Intent(getApplicationContext(), GetCashoutInfo.class);
