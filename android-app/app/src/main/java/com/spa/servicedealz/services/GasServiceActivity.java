 ...
 */
/**
 * FileName : GasServiceActivity
 * Description : Show GasService
 * Dependencies : Internet
 */
public class GasServiceActivity extends Activity implements View.OnClickListener, NetworkUtil.changeNetworkInterFace {
    // ActionBar actionBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewTitle.setText(getResources().getText(R.string.gas_services));
        ...
        //==========================================================================================
        NetworkUtil.setChangeNetWorkListener(GasServiceActivity.this);
        mIsInternetPresent = NetworkUtil.isConnectingToInternet(GasServiceActivity.this);
        if (!mIsInternetPresent) {
            // Internet Connection is not present
            Toast.makeText(GasServiceActivity.this, "No Internet Connection!",
    ...
    class HttpGetAsyncTask_unsubscribe extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(GasServiceActivity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                response = Jsondata.get_Unsuscribe_service(sp.getString("app_user_id", ""), String.valueOf(getResources().getText(R.string.gas_id)), GasServiceActivity.this);
       ...
       /* *
        ...
        protected void onPostExecute(String response) {
            ...
            if (Jsondata.Success.equalsIgnoreCase("true")) {
                ...
                ShowDailog.Show_Alert_Login(GasServiceActivity.this, getResources().getText(R.string.server_error).toString());
            }
        }
    ...
    class HttpGetAsyncTask_vender extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                SharedPreferences sp = getSharedPreferences("Pref_name",
                        Activity.MODE_WORLD_READABLE);
                mVenderlist = Jsondata.getservices_provider(sp.getString("app_user_id", ""), String.valueOf(getResources().getText(R.string.gas_id)), GasServiceActivity.this);
       ...
       /* *
        ...
        protected void onPostExecute(String response) {
            ...
            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(GasServiceActivity.this, android.R.layout.simple_spinner_dropdown_item, array); //selected item will look like a spinner set from XML
            ...
            case R.id.btn_update:
                if (!mIsInternetPresent) {
                    ...
                    if (mSpinnerVender.getSelectedItem().toString().equalsIgnoreCase("Select Vendor")) {
                        Toast.makeText(GasServiceActivity.this, "Please Select Vendor",
    ...
    class HttpGetAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                response = Jsondata.getservices(sp.getString("app_user_id", ""), String.valueOf(getResources().getText(R.string.gas_id)), provider_id, mEditTextEndDate.getText().toString(), is_contract, price,"","","", GasServiceActivity.this);
        ...
        protected void onPostExecute(String response) {
            ...
            if (Jsondata.Success.equalsIgnoreCase("true")) {
                SharedPreferences sp = getSharedPreferences("Pref_name",
                        Activity.MODE_WORLD_READABLE);
                SharedPreferences.Editor editor = sp.edit();
                editor.putString("gas_completed", "yes");
                editor.commit();
                finish();
    ...
    class HttpGetAsyncTask_get extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                SharedPreferences sp = getSharedPreferences("Pref_name",
                        Activity.MODE_WORLD_READABLE);
                service_prefrences = Jsondata.getservices_prefences(sp.getString("app_user_id", ""), String.valueOf(getResources().getText(R.string.gas_id)), GasServiceActivity.this);
...
//==================================================================================================
                    ...
                    // Show_Dailog.Show_Alert_Login(Gas_Services.this, getResources().getText(R.string.server_error).toString());
                }
            } catch (Exception e) {
            }
        }
