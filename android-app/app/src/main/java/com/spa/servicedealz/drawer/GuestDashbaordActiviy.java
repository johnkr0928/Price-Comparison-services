...
import com.spa.fragment.GuestDashbaordFragment;
 ...
 */
public class GuestDashbaordActiviy extends SlideMenuActivity {
    private GuestDashbaordFragment mDashboardFragment;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDashboardFragment = GuestDashbaordFragment.newInstance();
...
//        Localytics.setLoggingEnabled(true);
    ...
    protected void onResume() {
        ...
        Localytics.tagScreen("GuestDashboardActivity");
    }
    ...
    protected void onStart() {
        ...
        mTracker.setScreenName("Image~" + "GuestDashboardActivity");
