...
/**
 * Created by Diwakar on 4/20/2016.
 */
public class IntroScreenActivity extends Activity {
    ...
    private void setViewPager() {
        adapter = new ViewPagerAdapter(IntroScreenActivity.this, mImageArrayintro);
        ...
        mButtonGotIt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mEditor.commit();
                Intent in = new Intent(IntroScreenActivity.this,
                        LoginActivity.class);
                startActivity(in);
                finish();
    ...
    private int mImageArrayintro[] = {R.drawable.intro1, R.drawable.intro2,
            R.drawable.intro3};
