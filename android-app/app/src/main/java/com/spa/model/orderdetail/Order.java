...
public class Order {
    ...
    @SerializedName("provider_order_number")
    @Expose
    private Object providerOrderNumber;
     ...
     */
    public Object getProviderOrderNumber() {
     ...
     *     The provider_order_number
     */
    public void setProviderOrderNumber(Object providerOrderNumber) {
