...
public class Deals {
    ...
    @Expose
    private List<DealAdditionalOffer> dealAdditionalOffers = new ArrayList<DealAdditionalOffer>();
     ...
     */
    public List<DealAdditionalOffer> getDealAdditionalOffers() {
     ...
     */
    public void setDealAdditionalOffers(List<DealAdditionalOffer> dealAdditionalOffers) {
