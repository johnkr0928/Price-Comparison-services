...
import co.spa.sidemenu.R;
import co.spa.sidemenu.animation.FlipAnimation;
...
/**
 * Created by Diwakar on 12.01.2015.
 */
public class ViewAnimator<T extends Resourceble> {
    ...
    public ViewAnimator(AppCompatActivity activity,
        ...
        this.appCompactActivity = activity;
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            View viewMenu = appCompactActivity.getLayoutInflater().inflate(R.layout.menu_list_item, null);
            final int finalI = i;
            ...
            TextView name = (TextView) viewMenu.findViewById(R.id.menu_item_name);
